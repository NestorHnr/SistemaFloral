...
namespace SistemaFloral.AccesoDatos.Migrations
{
    ...
    [Migration("20231204010420_QuitarNombreProducto")]
    partial class QuitarNombreProducto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Bodega", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.BodegaProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.CarroCompra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.InventarioDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.KardexInventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Ocasion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Orden", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.OrdenDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrdeenDetalles");
                });

            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.UsuarioAplicacion", b =>
                {
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.BodegaProducto", b =>
                {
                    ...
                    b.HasOne("SistemaFloral.Modelos.Modelos.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.CarroCompra", b =>
                {
                    ...
                    b.HasOne("SistemaFloral.Modelos.Modelos.UsuarioAplicacion", "UsuarioAplicacion")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.InventarioDetalle", b =>
                {
                    b.HasOne("SistemaFloral.Modelos.Modelos.Inventario", "Inventario")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.KardexInventario", b =>
                {
                    b.HasOne("SistemaFloral.Modelos.Modelos.BodegaProducto", "BodegaProducto")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.OrdenDetalle", b =>
                {
                    b.HasOne("SistemaFloral.Modelos.Modelos.Orden", "Orden")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaFloral.Modelos.Modelos.Producto", b =>
                {
                    b.HasOne("SistemaFloral.Modelos.Modelos.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SistemaFloral.Modelos.Modelos.Ocasion", "Ocasion")
                        .WithMany()

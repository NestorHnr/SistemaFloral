...
namespace SistemaFloral.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user.Role == null) //El valor se recibe desde el page
                    {
                        await _userManager.AddToRoleAsync(user, DS.Role_Cliente);//lo asigna caundo no aparece la opcion de ingresar roll queda como cliente
                    }
                    else 
                    {

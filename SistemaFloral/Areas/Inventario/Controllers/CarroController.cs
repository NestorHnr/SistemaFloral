...
namespace SistemaFloral.Areas.Inventario.Controllers
{
    ...
    public class CarroController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            carroCompraVM.Orden = new Modelos.Modelos.Orden();
            ...
            {
                lista.Precio = lista.Producto.Costo; //siempre mostrar el precio actual del producto
        ...
        public async Task<IActionResult> remover(int carroId) 
        {
            ...
            //removemos el registro del carro de compras y actualiza la sesion
            var carroLista = await _unidadTrabajo.CarroCompra.ObtenerTodos(c => c.UsuarioAplicacionId == carroCompras.UsuarioAplicacionId);
